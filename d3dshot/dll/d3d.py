...
class ID3D11DeviceChild(comtypes.IUnknown):  # type: ignore[misc,name-defined] # TODO (Avasam): Figure out why it's Any
...
class ID3D11Device(comtypes.IUnknown):  # type: ignore[misc,name-defined] # TODO (Avasam): Figure out why it's Any
